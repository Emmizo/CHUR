...
<body width="10" height="100" align="center">
  ...
  <div class="se-pre-con"></div>
    	...
    	<form action="selectprogram_dept.php" method="GET" >
    		...
    		$qr="SELECT program_dept.id,program_dept.dept_id, program.program_name, level.level_name,departement.dept_name from program_dept 
    		INNER JOIN program ON program.program_id=program_dept.program_id2
    		INNER JOIN level ON level.level_id=program_dept.level_id2
    		INNER JOIN departement ON departement.dept_id=program_dept.dept_id ORDER BY dept_id ASC, program_id ASC,level_id ASC";
