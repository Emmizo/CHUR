...
$ID=$_GET['ID'];
	...
	$query="SELECT DISTINCT students.reg_id,faculity.faculity_name,registration.intake,program.program_id, students.ID, students.f_name,students.l_name,students.email,students.sex,students.tel,departement.dept_id,level.level_id from students
...
if (isset($_POST['update'])) {
  ...
  $query2="UPDATE students
         ...
         INNER JOIN level ON level.level_id=registration.level_id SET students.f_name='$f_name',students.l_name='$l_name',students.sex='$sex',students.tel='$tel',students.email='$email',registration.ID='$ID',registration.dept_id='$dept',registration.program_id='$program',registration.level_id='$level',registration.intake='$intake' WHERE registration.idreg='$ID'";
				...
				<script type="text/javascript" src="js/jquery-1.4.1.min.js"></script>
					...
					<div class="row"  >
						<div class="col-lg-4 col-lg-offset-4 col-md-12 col-sm-12" ">
							...
							<div class="input-field col-lg-12 col-md-12 col-sm-12">
								<label>Program:</label>
								<input class="form-control" type="text" name="program_id" value="<?php echo $programid;?>">
							</div>
							<div class="input-field col-lg-12 col-md-12 col-sm-12">
								<label>Level:</label>
